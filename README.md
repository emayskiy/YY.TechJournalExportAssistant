...
Секция **"TechJournal"** содержит параметры обработки журнала регистрации:
...
Библиотека может быть использования для создания приложений для экспорта стандартного журнала регистрации платформы 1С:Предприяние 8.ч в нестандартные хранилища, которые упрощают анализ данных и повзоляют организовать эффективный мониторинг.
